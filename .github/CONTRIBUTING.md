# Contributing to create-k6-extension

Thank you for your interest in contributing to create-k6-extension!
...
If you'd like to contribute code to create-k6-extension, this is the basic procedure. Make sure to follow the [style guide](#style-guide) described below.
...
To get a basic development environment for Go and create-k6-extension up and running, first make sure you have **[Git](https://git-scm.com/downloads)** and **[Go](https://golang.org/doc/install)** (see our [go.mod](https://github.com/szkiba/create-k6-extension/blob/master/go.mod) for minimum required version) installed and working properly.

We recommend using the Git command-line interface to download the source code for the create-k6-extension:

* Open a terminal and run `git clone https://github.com/szkiba/create-k6-extension.git`. This command downloads xk6-dashboard's sources to a new `create-k6-extension` directory in your current directory.
* Open the `create-k6-extension` directory in your favorite code editor.

For alternative ways of cloning the create-k6-extension repository, please refer to [GitHub's cloning a repository](https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/cloning-a-repository) documentation.

#### Running the linter

We make use of the [golangci-lint](https://github.com/golangci/golangci-lint) tool to lint the code in CI. The actual version you can find in our [`.golangci.yml`](https://github.com/szkiba/create-k6-extension/blob/master/.golangci.yml#L1). To run it locally run:
